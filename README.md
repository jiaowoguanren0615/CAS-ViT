...
![image](https://github.com/Tianfang-Zhang/CAS-ViT/raw/main/misc/tokenmixer.png)  
![image](https://github.com/Tianfang-Zhang/CAS-ViT/raw/main/misc/arch.png)  
...
## For segmentation tasks, please refer this [github warehouse](https://github.com/jiaowoguanren0615/Segmentation_Factory/blob/main/models/backbones/casvit.py)

### Download the dataset: 
[flower_dataset](https://www.kaggle.com/datasets/alxmamaev/flowers-recognition).  
### Download the pretrained weights
[pretrained weights](https://github.com/Tianfang-Zhang/CAS-ViT/tree/main/model_zoo)
...
```bash
python onnx_export.py --model=rcvit_s --output=./rcvit_s.onnx --checkpoint=./output/rcvit_s_best_checkpoint.pth
```

### step2: ONNX optimise
```bash
python onnx_optimise.py --model=rcvit_s --output=./rcvit_s_optim.onnx
```

### step3: ONNX validate (modify the param of ___data_root___ and ___onnx-input___)  
```bash
python onnx_validate.py --data_root=/mnt/d/flower_data --onnx-input=./rcvit_s_optim.onnx
```
