...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'CAS-ViT training and evaluation script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='rcvit_s', type=str, metavar='MODEL',
                        choices=['rcvit_xs', 'rcvit_s', 'rcvit_m', 'rcvit_t'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'CAS-ViT training and evaluation script', parents=[get_args_parser()])
